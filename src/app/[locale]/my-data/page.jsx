        ...
        <main className="lg:p-6 p-4 min-h-[calc(100vh-132px)]">
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="bg-[#003d5cE6] card ">
              ...
              <div className="mt-6">
                <div className="w-full bg-[#045786] h-4 icon-box">
                  <div className="bg-[#fd8c25] h-4 text-white text-xs text-center" style={{ 'width': '85%' }}>
            ...
            <div className="bg-[#003d5cE6] card ">
              ...
              <div className="mt-6 flex justify-between">
                <label className="flex justify-between w-full items-center cursor-pointer">
                  <span className="text-sm text-gray-300 font-bold">Data stream</span>
            ...
            <div className="bg-[#003d5cE6] card ">
              ...
              <div className="w-full bg-[#045786] h-4 icon-box">
                <div className="bg-[#20c2ac] h-4 text-white text-xs text-center" style={{ 'width': '75%' }}>
                </div>
              </div>
            ...
            <div className="bg-[#003d5cE6] card ">
              <div className="flex justify-between items-center">
                ...
                <span className="text-[#5a96e0] text-4xl">
              ...
              <div className="mt-4">
                ...
                <div className="w-full bg-[#045786] h-4 icon-box">
                  <div className="bg-[#ac7be2] h-4 text-white text-xs text-center" style={{ 'width': '85%' }}></div>
                </div>
              </div>
              <div className="mt-4">
                <div className="flex justify-between">
                ...
                <div className="w-full bg-[#045786] h-4 icon-box">
                  <div className="bg-[#fb923c] h-4 text-white text-xs text-center" style={{ 'width': '75%' }}></div>
                </div>
              </div>
              <div className="mt-4">
                <div className="flex justify-between">
                ...
                <div className="w-full bg-[#045786] h-4 icon-box">
                  <div className="bg-[#d969a6] h-4 text-white text-xs text-center" style={{ 'width': '95%' }}></div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1  mt-4">
            ...
            <div className="bg-[#003d5cE6] card ">
              <div className="flex justify-between items-center">
                ...
                <div>
                  <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className=" py-3 px-6  bg-[#0098c0] text-white hover:bg-blue-800 flex items-center justify-center gap-2  font-semibold hover:bg-[#00f6ff] hover:text-[#000000] transition-all duration-500  icon-box" type="button">
              ...
              <table class="table-auto w-full">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="text-left">Cycling</td>
                    <td class="text-left">45</td>
                    <td class="text-left">400</td>
                  </tr>
                  <tr>
                    <td class="text-left">Swimming</td>
